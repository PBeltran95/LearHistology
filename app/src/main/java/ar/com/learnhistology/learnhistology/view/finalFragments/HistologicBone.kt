...
import ar.com.learnhistology.learnhistology.databinding.FragmentHistologicBoneBinding
...
class HistologicBone : Fragment() {
    ...
    private var _binding: FragmentHistologicBoneBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHistologicBoneBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (organId) {
            ...
            "5" -> binding.expandTextView.setText(text3)
        ...
        when (organId) {
            ...
            "5" -> images = arrayOf(R.drawable.eye, R.drawable.fat, R.drawable.bronquio)
            "6" -> images = arrayOf(R.drawable.bulboolfatorio, R.drawable.bulboolfatorio, R.drawable.bulboolfatorio)
        }
