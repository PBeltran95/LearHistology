...
import ar.com.learnhistology.learnhistology.databinding.FragmentHistologicCardiovascularBinding
...
class HistologicReproductor : Fragment() {
    ...
    private var _binding: FragmentHistologicReproductorBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHistologicReproductorBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (organId) {
            ...
            "5" -> binding.expandTextView.setText(text1)
            "6" -> binding.expandTextView.setText(text2)
            "7" -> binding.expandTextView.setText(text3)
            "8" -> binding.expandTextView.setText(text4)
            "9" -> binding.expandTextView.setText(text1)
            "10" -> binding.expandTextView.setText(text2)
            "11" -> binding.expandTextView.setText(text3)
            "12" -> binding.expandTextView.setText(text4)
            "13" -> binding.expandTextView.setText(text3)
        ...
        when (organId) {
            ...
            "5" -> images = arrayOf(R.drawable.epitelium, R.drawable.urinary, R.drawable.endocrin)
            "6" -> images = arrayOf(R.drawable.alveolo, R.drawable.cardio, R.drawable.digestivo)
            "7" -> images = arrayOf(R.drawable.eye, R.drawable.fat, R.drawable.bronquio)
            "8" -> images = arrayOf(R.drawable.bulboolfatorio, R.drawable.bulboolfatorio, R.drawable.bulboolfatorio)
            "9" -> images = arrayOf(R.drawable.epitelium, R.drawable.urinary, R.drawable.endocrin)
            "10" -> images = arrayOf(R.drawable.alveolo, R.drawable.cardio, R.drawable.digestivo)
            "11" -> images = arrayOf(R.drawable.eye, R.drawable.fat, R.drawable.bronquio)
            "12" -> images = arrayOf(R.drawable.bulboolfatorio, R.drawable.bulboolfatorio, R.drawable.bulboolfatorio)
            "13" -> images = arrayOf(R.drawable.eye, R.drawable.fat, R.drawable.bronquio)
