...
import ar.com.learnhistology.learnhistology.databinding.FragmentHistologicTegumentaryBinding
...
class HistologicTegumentary : Fragment() {
    ...
    private var _binding: FragmentHistologicTegumentaryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHistologicTegumentaryBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (organId) {
            ...
            "5" -> images = arrayOf(R.drawable.bulboolfatorio, R.drawable.bulboolfatorio, R.drawable.bulboolfatorio)
        }
