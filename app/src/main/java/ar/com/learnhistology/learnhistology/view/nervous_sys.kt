...
import ar.com.learnhistology.learnhistology.databinding.FragmentNervousSysBinding
import ar.com.learnhistology.learnhistology.databinding.FragmentUrinarySysBinding

class nervous_sys : Fragment() {

    private var _binding: FragmentNervousSysBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentNervousSysBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun toHistologic() {
        binding.cardio1.setOnClickListener {
            ...
            nervous_sysDirections.actionNervousSysToHistologicNervous(buttonText)
            view?.findNavController()?.navigate(nervous_sysDirections.actionNervousSysToHistologicNervous(buttonText))
        }
